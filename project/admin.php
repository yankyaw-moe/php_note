                        ...
                        <?php if ($auth->value > 1) : ?>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a href="_actions/role.php?id=<?= $user->id ?>&role=1" class="dropdown-item">User</a></li>
                                    <li><a href="_actions/role.php?id=<?= $user->id ?>&role=2" class="dropdown-item">Manager</a></li>
                                    <li><a href="_actions/role.php?id=<?= $user->id ?>&role=3" class="dropdown-item">Admin</a></li>
                                </ul> -->
